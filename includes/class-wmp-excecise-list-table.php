...
class Wmp_Excercise_List_Table extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( array(
			'singular' => 'excercise',     // Singular name of the listed records.
			'plural'   => 'excercises',    // Plural name of the listed records.
	...
	protected function process_bulk_action() {
		...
		global $wpdb;
        $table_name = $wpdb->prefix . 'wmp_excercise'; // do not forget about tables prefix
